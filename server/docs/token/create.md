...
{
  "code": 400,
  "message": "参数错误: ai_model_id is required"
}
```
...
- `token` 字段由系统自动生成，格式为 `sk-` + 16位十六进制字符串
- Token 值唯一，创建成功后需妥善保存
